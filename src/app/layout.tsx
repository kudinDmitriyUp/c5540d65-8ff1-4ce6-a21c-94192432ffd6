...
export const metadata: Metadata = {
  title: "Premium Ethical Coffee | Brew Haven",
  description: "Sip exceptional coffee, ethically sourced and expertly roasted. Delivered fresh to your door with subscription savings. Join 5,000+ coffee lovers.",
  keywords: "ethically sourced coffee, specialty coffee beans, coffee subscription, artisan coffee, fair trade coffee",
  ...
  openGraph: {
    title: "Premium Ethical Coffee | Brew Haven",
    description: "Sip exceptional coffee, ethically sourced and expertly roasted. Delivered fresh to your door.",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_363fycCW5gR5mBuwyI3Zdk1DwTq/uploaded-1765795675598-tikjun02.jpg",
  ...
  twitter: {
    ...
    title: "Premium Ethical Coffee | Brew Haven",
    description: "Exceptional coffee delivered fresh. Ethically sourced, expertly roasted."
  }
};
